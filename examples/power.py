...
print(
    ...
    + loop(
        ...
        + switchon(
            ...
            at(3, s(0)) + at(8+3, s(2)) + at(5, move(-5+8+5)) + g(8),
            # func2(a): check a using b
            switchon(
                5,
                # if a!=0 save func3(a=a) and push func2(a=a-1)
                at(3, s(3)) + at(8+3, s(2)) + at(5, c(-1) + copy(2, -5+8+5) + c(1)) + g(8),
                # else set a=1 and pop
                at(5, s(1)) + g(-8),
            ),
            # func3(a): save func4(a=a, b=^a) and push func2(a=a-1)
            at(6, s(0)) + at(8+5, move(-5-8+6)) + at(3, s(0) + c(4)) + at(8+3, s(2)) + at(5, c(-1) + copy(2, -5+8+5) + c(1)) + g(8),
            # func4(a, b): set a=b+^a and pop
            at(7, s(0)) + at(8+5, move(-5-8+7)) + at(5, s(0)) + at(6, move(-6+5)) + at(7, move(-7+5)) + g(-8),
        )
        + c(1)
    )
    + c(-1)
